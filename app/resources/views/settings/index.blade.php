    ...
    <div class="p-6 pt-16 lg:pt-6 max-w-3xl mx-auto">
        <div class="card-daten shadow-xl p-6 ">
            ...
            <form method="POST" action="{{ route('settings.update') }}">
                ...
                {{-- Notas por página --}}
                <div class="mb-6 pb-6 border-b border-daten rounded-md p-4">
                    ...
                    <div class="flex items-center gap-4 flex-wrap">
                        <span class="text-daten-secondary">Mostrar</span>
...
<!--                     
                    ...
                    <div class="mb-6 pb-6 border-b border-daten rounded-md p-4" >
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="ruta_personal" value="{{ $settings['ruta_personal'] }}"
                                class="w-full input-daten placeholder:text-daten-muted focus:border-brand-glow focus:ring-2 focus:ring-brand-glow/30 transition-all duration-200 rounded-md "
                                placeholder="ej: proyectos, trabajos, apuntes, diario, anotaciones, notas">
                            <p class="text-xs text-daten-muted mt-1.5">
                                <i class="fa-solid fa-info-circle mr-1"></i>
                                Solo letras minúsculas, entre 5 y 16 caracteres.
                            </p>
                            <p class="text-md text-red-500 mt-1 flex items-center gap-1.5">
                                <i class="fa-solid fa-triangle-exclamation"></i>
                                Evita cambiarla después, para asegurar la sincronización.
                            </p>
                        </div>
                        ...
                        {{-- ÁREA INFORMATIVA: Rutas del sistema --}}
                                <div class="w-[80%] mx-auto bg-daten-input p-3 sm:p-4 rounded-lg border border-daten space-y-2">
                                    <p class="text-sm text-daten-secondary flex flex-col sm:flex-row sm:items-center gap-1">
                                        ...
                                        <code class="sm:text-xs md:text-sm bg-daten-card px-2 py-0.5 rounded border border-daten text-daten-secondary break-all">
                                            {{ $settings['ruta_base'] }}
                                        </code>
                                    </p>
                                    <p class="text-sm text-daten-secondary flex flex-col sm:flex-row sm:items-center gap-1">
