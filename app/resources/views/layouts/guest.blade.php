...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}"
    ...
    <body class="font-sans antialiased page-daten text-daten-primary">
        ...
        <!-- ============================================ -->
        <div class="min-h-screen flex flex-col items-center justify-center px-4 py-3 page-daten">
            ...
            <!-- ============================================ -->
            <div class="w-full mt-3 text-center space-y-1 flex-shrink-0">
                ...
                <!-- URL y Versión -->
                <div>
                    <p class="text-[10px] text-daten-muted tracking-wide">
                    ...
                    <p class="text-[9px] text-daten-muted/50 mt-0.5">
